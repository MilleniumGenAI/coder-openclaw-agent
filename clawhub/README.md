...
```bash
clawhub publish clawhub/coder-openclaw-agent --slug coder-openclaw-agent --name "Coder for OpenClaw" --version 0.1.1 --tags latest
```

## Checklist
- `VERSION` matches the skill version.
- `SKILL.md` has valid YAML frontmatter.
- The skill points to the public GitHub repository and license.
